...
pub trait FetchDefinition: Definition {
    ...
    #[inline]
    fn fetch_from_index<D: Definition>(cache: &Cache, index_id: u8) -> crate::Result<HashMap<u32, D>> {
    ...
    ///     = ItemDefinition::parse_grouped(&cache, index_id, archive_id)?;
    /// # Ok(())
    /// # }
    /// ```
    // FIXME
    #[inline]
    fn fetch_from_archive<D: Definition>(
        cache: &Cache, 
        index_id: u8, 
        archive_id: u32
